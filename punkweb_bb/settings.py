...
GITHUB_CLIENT_ID = PUNKWEB_BB.get("GITHUB_CLIENT_ID", None)
GITHUB_CLIENT_SECRET = PUNKWEB_BB.get("GITHUB_CLIENT_SECRET", None)
GITHUB_AUTH_ENABLED = bool(GITHUB_CLIENT_ID and GITHUB_CLIENT_SECRET)
